python3 -u change_csv_to_parquet.py --folder=../../Data/2min/2016/
python3 -u change_csv_to_parquet.py --folder=../../Data/2min/2017/
python3 -u change_csv_to_parquet.py --folder=../../Data/2min/2018/
python3 -u change_csv_to_parquet.py --folder=../../Data/2min/2019/
python3 -u change_csv_to_parquet.py --folder=../../Data/2min/2020/
python3 -u change_csv_to_parquet.py --folder=../../Data/2min/2021/
